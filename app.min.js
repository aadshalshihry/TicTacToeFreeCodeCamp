...
function resetGameBord(sel, isInsideClick) {
	sel.find(">  *").children().each(function() {
		if(isInsideClick){
		// $(this).removeClass("bgWinner")

		}else{
			// $(this).removeClass("bgWinner");
			// $(this).children().removeClass("bgWinner")
			// $(this).children().empty();
		// $(this).empty();
...
$(document).ready(function () {
	...
	// });
	let chossenPlayer = []
	chossenPlayer = $("#X").on('click', chosePlayer("X", "O"))
	...
	$('#reset').on('click', function () {
		$("#row1, #row2, #row3").removeClass("bgWinner");
